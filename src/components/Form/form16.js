...
function Stuform16() {
    ...
    useEffect(() => {
      ...
      const createForm16 = () => {
        axios.post('/transaction/create-ro16', 
        {
            to_name : To_name,
            reason : Reason,
                                    ...
                                    <Form>
                                        <Form.Row>
                                            ...
                                            <Form.Group as={Col} sm={4} controlId="formGridEmail">
                                                ...
                                                <Form.Control type="Attach" placeholder="Attach"
                                                value={Attach_one}
                                                onChange={(e) => {
                                            ...
                                            <Form.Group as={Col} sm={4} controlId="formGridEmail">
                                                ...
                                                <Form.Control type="Attach" placeholder="Attach2"
                                                value={Attach_two}
                                                onChange={(e) => {
                                        ...
                                        <Form.Row>
                                            ...
                                            <Form.Group as={Col} sm={2} controlId="formGridState">
                                                ...
                                                <Form.Control type="date" name="dob" placeholder="Date of  Start"
                                                value={Start_date}
                                                onChange={(e) => {
                                            ...
                                            <Form.Group as={Col} sm={2} controlId="formGridState">
                                                ...
                                                <Form.Control type="date" name="dob" placeholder="Date of Expire"
                                                value={End_date}
                                                onChange={(e) => {
